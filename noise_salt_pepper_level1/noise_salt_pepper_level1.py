...
IMAGES = [
    {
        "caption": "Gambar Landscape Salt & Pepper Level 1",
        "filename": "pemandanganLS.jpg",
    },
    {
        "caption": "Gambar Landscape Grayscale Salt & Pepper Level 1",
        "filename": "pemandanganLS_gray.jpg",
    },
    {
        "caption": "Gambar Potrait Salt & Pepper Level 1",
        "filename": "objekPT.jpg",
    },
    {
        "caption": "Gambar Potrait Grayscale Salt & Pepper Level 1",
...
def main():
    ...
    for entry in IMAGES:
        ...
        # pastikan grayscale tetap 2D untuk menjaga format laporan
        ...
        if SHOW_WINDOWS:
            ...
            cv2.imshow(f"Noise Level 1 - {caption}", _resize_for_display(comparison_noisy))
            cv2.waitKey(0)
            cv2.destroyAllWindows()

    print("Noise Salt & Pepper Level 1 selesai dibangkitkan untuk seluruh citra.")
