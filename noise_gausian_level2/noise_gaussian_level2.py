...
IMAGES = [
    {
        "caption": "Gambar Landscape Gaussian Noise Level 2",
        "filename": "pemandanganLS.jpg",
    },
    {
        "caption": "Gambar Landscape Grayscale Gaussian Noise Level 2",
        "filename": "pemandanganLS_gray.jpg",
    },
    {
        "caption": "Gambar Potrait Gaussian Noise Level 2",
        "filename": "objekPT.jpg",
    },
    {
        "caption": "Gambar Potrait Grayscale Gaussian Noise Level 2",
        "filename": "objekPT_gray.jpg",
    },
]

NOISE_MEAN = 0.0
NOISE_STDDEV = 25.0  # Level 2: noise lebih kuat daripada level 1
SHOW_WINDOWS = True
...
def main() -> None:
    ...
    for entry in IMAGES:
        ...
        if SHOW_WINDOWS:
            ...
            cv2.imshow(f"Gaussian Noise Level 2 - {caption}", _resize_for_display(comparison_noisy))
            cv2.waitKey(0)
            cv2.destroyAllWindows()

    print("Noise Gaussian Level 2 selesai dibangkitkan untuk seluruh citra.")
